...
(function () {
  ...
  var STYLES = [
    ...
    '  --radius:10px;',
    '  font-family:"DM Sans",sans-serif;font-size:14px;line-height:1.55;color:var(--ink);',
    '  background:var(--paper);max-width:1080px;margin:0 auto;',
    '}',
    '#bdna-ecosystem *,#bdna-ecosystem *::before,#bdna-ecosystem *::after{box-sizing:border-box;margin:0;padding:0;}',
    '#bdna-ecosystem .bdna-page{padding-bottom:64px;}',
    // Hero
    '#bdna-ecosystem .hero{padding:56px 56px 48px;}',
    '#bdna-ecosystem .title-strip{font-family:"DM Mono",monospace;font-size:11px;font-weight:500;letter-spacing:.24em;color:var(--teal);margin-bottom:14px;}',
    '#bdna-ecosystem .hero-title{font-size:52px;font-weight:600;color:var(--ink);line-height:1;letter-spacing:-.02em;margin-bottom:18px;}',
    '#bdna-ecosystem .hero-sub{font-size:18px;color:var(--ink-soft);max-width:560px;line-height:1.5;margin-bottom:40px;}',
    // Molecule stage layout
    '#bdna-ecosystem .molecule-stage{display:grid;grid-template-columns:1fr 280px;gap:32px;align-items:start;margin-top:8px;}',
    '#bdna-ecosystem .molecule-wrap{background:var(--paper-soft);border-radius:var(--radius);border:1px solid var(--rule);padding:24px;}',
    '#bdna-ecosystem .molecule{width:100%;height:auto;display:block;}',
    // Info panel
    '#bdna-ecosystem .info-panel{background:var(--paper-soft);border-radius:var(--radius);border:1px solid var(--rule);padding:24px 22px;min-height:260px;transition:border-color .2s ease;}',
    ...
    '#bdna-ecosystem .info-label{font-family:"DM Mono",monospace;font-size:11px;font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:var(--teal);margin-bottom:10px;}',
    '#bdna-ecosystem .info-hint{font-size:13px;color:var(--ink-mute);line-height:1.55;}',
    '#bdna-ecosystem .info-node-label{font-family:"DM Mono",monospace;font-size:11px;font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:var(--teal);margin-bottom:14px;}',
    '#bdna-ecosystem .info-opener{font-size:16px;font-weight:600;color:var(--ink);line-height:1.4;margin-bottom:14px;}',
    '#bdna-ecosystem .info-body{font-size:14px;color:var(--ink-soft);line-height:1.65;}',
    // Molecule visuals
    '#bdna-ecosystem .bond{stroke:var(--teal-nucleus);stroke-width:1;opacity:.6;}',
    '#bdna-ecosystem .loop-arc{stroke:var(--teal-nucleus);stroke-width:1;stroke-dasharray:4 4;opacity:.18;transition:opacity .25s ease;}',
    '#bdna-ecosystem .feedback-loop.engaged .loop-arc{opacity:.55;}',
    '#bdna-ecosystem .node{cursor:pointer;transition:opacity .2s ease,transform .2s ease;transform-origin:center;}',
    '#bdna-ecosystem .node:focus{outline:none;}',
    '#bdna-ecosystem .node:focus-visible .node-shape{stroke-width:2.5;}',
    '#bdna-ecosystem .node-shape{transition:fill .2s ease,stroke .2s ease,stroke-width .2s ease;}',
    '#bdna-ecosystem .nucleus .node-shape{fill:var(--teal-nucleus);stroke:var(--teal-deep);stroke-width:1.5;}',
    '#bdna-ecosystem .core .node-shape{fill:var(--teal-soft);stroke:var(--teal-nucleus);stroke-width:1;}',
    '#bdna-ecosystem .nucleus-label{font-family:"DM Mono",monospace;font-size:16px;font-weight:700;fill:var(--teal-soft);letter-spacing:.12em;pointer-events:none;}',
    '#bdna-ecosystem .core-label{font-family:"DM Mono",monospace;font-size:14px;font-weight:700;fill:#085041;letter-spacing:.12em;pointer-events:none;}',
    '#bdna-ecosystem .core-label.env{letter-spacing:.04em;}',
    '#bdna-ecosystem .node:hover .node-shape,#bdna-ecosystem .node.active .node-shape{stroke-width:2.5;}',
    '#bdna-ecosystem .node.dimmed{opacity:.45;}',
    // Page sections
    '#bdna-ecosystem .page-section{padding:48px 56px;border-top:1px solid var(--rule);}',
    '#bdna-ecosystem .section-label{font-family:"DM Sans",sans-serif;font-size:11px;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:var(--teal);margin-bottom:28px;padding-bottom:14px;border-bottom:1px solid var(--rule);}',
    '#bdna-ecosystem .prose{font-size:15px;color:var(--ink);line-height:1.7;max-width:680px;margin-bottom:18px;}',
    '#bdna-ecosystem .prose:last-child{margin-bottom:0;}',
    '#bdna-ecosystem .prose strong{font-weight:600;color:var(--ink);}',
    '#bdna-ecosystem .component-row{display:grid;grid-template-columns:180px 1fr;gap:32px;padding:20px 0;border-bottom:1px dashed var(--rule);align-items:start;}',
    '#bdna-ecosystem .component-row:last-child{border-bottom:0;}',
    '#bdna-ecosystem .component-label{font-family:"DM Mono",monospace;font-size:13px;font-weight:600;letter-spacing:.14em;text-transform:uppercase;color:var(--teal);padding-top:2px;}',
    '#bdna-ecosystem .component-text p{font-size:15px;color:var(--ink);line-height:1.65;max-width:560px;}',
    '#bdna-ecosystem .component-text strong{color:var(--ink);font-weight:600;}',
    // Tools
    '#bdna-ecosystem .tools-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:18px;margin-top:24px;}',
    ...
    '#bdna-ecosystem .tool-card-tag{font-family:"DM Mono",monospace;font-size:10px;font-weight:500;letter-spacing:.16em;text-transform:uppercase;color:var(--teal);margin-bottom:14px;}',
    '#bdna-ecosystem .tool-card-name{font-size:20px;font-weight:600;color:var(--ink);margin-bottom:10px;}',
    '#bdna-ecosystem .tool-card-body{font-size:13.5px;color:var(--ink-soft);line-height:1.6;margin-bottom:18px;}',
    '#bdna-ecosystem .tool-card-link{font-family:"DM Mono",monospace;font-size:11px;font-weight:600;letter-spacing:.10em;text-transform:uppercase;color:var(--teal);text-decoration:none;}',
    '#bdna-ecosystem .tool-card-link:hover{color:var(--teal-dark);}',
    // CTA
    '#bdna-ecosystem .cta{background:var(--teal-tint);border:1px solid var(--teal-border);border-radius:var(--radius);padding:32px 36px;margin:32px 56px 0;display:grid;grid-template-columns:1fr auto;gap:32px;align-items:center;}',
    '#bdna-ecosystem .cta-tag{font-family:"DM Sans",sans-serif;font-size:10px;font-weight:500;letter-spacing:.20em;text-transform:uppercase;color:var(--teal);margin-bottom:10px;}',
    '#bdna-ecosystem .cta-headline{font-size:18px;font-weight:600;color:var(--ink);margin-bottom:8px;line-height:1.35;}',
    '#bdna-ecosystem .cta-body{font-size:13.5px;color:var(--ink-soft);line-height:1.6;max-width:560px;}',
    '#bdna-ecosystem .cta-btn{display:inline-block;background:var(--teal);color:#fff;padding:12px 28px;border-radius:5px;text-decoration:none;font-weight:700;font-size:14px;white-space:nowrap;}',
    '#bdna-ecosystem .cta-btn:hover{background:var(--teal-dark);}',
    // Responsive
    '@media (max-width:880px){',
    '  #bdna-ecosystem .hero,#bdna-ecosystem .page-section{padding-left:28px;padding-right:28px;}',
    '  #bdna-ecosystem .cta{margin-left:28px;margin-right:28px;padding:24px;grid-template-columns:1fr;}',
    '  #bdna-ecosystem .hero-title{font-size:36px;}',
    '  #bdna-ecosystem .hero-sub{font-size:16px;}',
